  ...
  render () {
    ...
    return (
      <Row type="flex" style={{marginTop: 16}}  className={styles['table-row']}>
        ...
        <Col span={8} className={styles['table-span']}><InputWrapper text={ AssetInfoData.productType } /></Col>
        ...
        <Col span={8} className={styles['table-span']}><InputWrapper text={ AssetInfoData.deposit } /></Col>
        ...
        <Col span={8} className={styles['table-span']}><InputWrapper text={ AssetInfoData.rrpairType } /></Col>
        <Col span={4} className={styles['table-span']}>保养分类</Col>
        <Col span={8} className={styles['table-span']}><InputWrapper text={ AssetInfoData.maintainType } /></Col>
        <Col span={4} className={styles['table-span']}>计量分类</Col>
        <Col span={8} className={styles['table-span']}><InputWrapper text={ AssetInfoData.meteringType } /></Col>
        <Col span={4} className={styles['table-span']}>保养周期</Col>
        <Col span={8} className={styles['table-span']}><InputWrapper text={ AssetInfoData.maintainDay } /></Col>
        ...
        <Col span={8} className={styles['table-span']}><InputWrapper text={ AssetInfoData.spare } /></Col>
      </Row>
    )
  }
}
